//***************获取元素*************************
var f2_cop_dom = document.getElementById("f2_whp_cop_chart");
var f2_cop_pie_dom = document.getElementById("f2_whp_cop_pie");
var f3_cop_dom = document.getElementById("f3_whp_cop_chart");
var f3_cop_pie_dom = document.getElementById("f3_whp_cop_pie");
var f4_cop_dom = document.getElementById("f4_whp_cop_chart");
    ...
    $.ajax(
        {
            ...
            success: function (data) {
                ...
                f3_cop_pie.setOption(
                    get_cop_pie_options(data["f3_whp_cop"][data["f3_whp_cop"].length-1])
                );
                ...
                f4_cop_pie.setOption(
                    get_cop_pie_options(data["f4_whp_cop"][data["f4_whp_cop"].length-1])
                );
                ...
                f5_cop_pie.setOption(
                    get_cop_pie_options(data["f5_whp_cop"][data["f5_whp_cop"].length-1])
                );
            ...
            error: function (xhr) {
                console.log("post water_source_cop error：", xhr);
            }
        }
    );
}catch (e) {
    console.log("ajax water_source_cop error：", e);
}
